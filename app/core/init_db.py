...
async def create_user(
    ...
    Args:
        ...
        is_superuser (bool, default = False): Является ли пользователь
        суперпользователем. По умолчанию False.
...
async def create_first_superuser():
    """
    Создает первого суперпользователя, если указаны его email и пароль
    в настройках.
    """
